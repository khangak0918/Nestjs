...
//   };
//   status: string | number; // Hoặc kiểu dữ liệu chính xác của status sau khi convert
//   homeTeam: {
//     id: string;
//     name: string;
//     slug: string;
...
// // Giả định đây là một hàm bạn đã định nghĩa để chuyển đổi status code
// const convertStatusCode = (code: number): string | number => {
//   // Implement logic chuyển đổi code tại đây
//   switch (code) {
//     case 0:
//       return 'Not Started';
//     case 1:
...
//         ? undefined // Thay {} bằng undefined cho kiểu optional
//         : {
...
//     } as SportEventDtoWithStat; // Thêm type assertion ở đây
//   });
//   return matches;
// };
...
//   // Kiểm tra nếu matches là null hoặc undefined

//   if (matches.length === 0) {
//     return <div className="layout relative flex min-h-screen flex-col items-center justify-center py-12 text-center">Loading...</div>;
//   }

  

//   return (
//     <div className="layout relative flex max-w-screen-2xl min-h-screen flex-col items-center justify-center py-12 text-center">
...
//           return (
//             <li key={match.id} className="border p-4 rounded shadow-md">
//               <p>{`Id: ${match.id}`}</p>
